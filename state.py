...
class QAResult(BaseModel):
    ...
    requires_clarification: bool = Field(default=False, description="True if the player's input is confusing or if a tool was executed incorrectly and the engine needs to ask the player to clarify.")
    clarification_message: str = Field(default="", description="If requires_clarification is True, write an OOC message directly to the player asking them to clarify.")
...
class CharacterDetails(Social):
    ...
    code_switching: str = Field(default="", description="Can they adapt their accent/mannerisms to fit into different social classes or situations? IMPROVISE.")
...
class LocationDetails(Social):
    ...
    key_features_and_landmarks: str = Field(default="", description="Notable architecture or geographical features. IMPROVISE.")
    ...
    diversity: str = Field(default="", description="The specific types of folk, races, or factions players might encounter here. Is it a homogeneous or diverse melting pot? IMPROVISE.")
